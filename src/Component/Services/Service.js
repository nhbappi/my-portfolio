                ...
                <div className="row">
                    <div className="col__3">
                       <div className="service__box pointer">
                        ...
                        <div className="service__meta">
                         <h1 className="service__text">FrontEnd Development Service</h1>
                       ...
                       <div className="service__box pointer">
                        ...
                        <div className="service__meta">
                         <h1 className="service__text">
                          Full-Stack Web Development Service</h1>
                         <p className="service__text p__color">loremLorem ipsum dolor sit ame</p>
                         <p className="service__text p__color">loremLorem ipsum dolor sit ame</p>
                         <p className="service__text p__color">loremLorem ipsum dolor sit ame</p>
                        </div>
                    ...
                    <div className="col__3">
                       <div className="service__box pointer">
                        ...
                        <div className="service__meta">
                         <h1 className="service__text">Ecommerce Applications Service</h1>
                         <p className="service__text p__color">loremLorem ipsum dolor sit ame</p>
                         <p className="service__text p__color">loremLorem ipsum dolor sit ame</p>
                         <p className="service__text p__color">loremLorem ipsum dolor sit ame</p>
                        </div>
