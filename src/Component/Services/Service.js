                ...
                <div className="row">
                    <div className="col__3">
                       <div className="service__box pointer">
                        ...
                        <div className="service__meta">
                         ...
                         <p className="service__text p__color">I am expert in web designing. I can add functionality besides designing a webpage. I use HTML, CSS, Bootstrap, Vanilla Js, React JS for it. You can see some of my works below</p>
                        </div>
                       </div>
                    </div>
                    <div className="col__3">
                       <div className="service__box pointer">
                        ...
                        <div className="service__meta">
                         <h1 className="service__text">
                          MERN Stack Web Development </h1>
                         <p className="service__text p__color">I am a MERN stack web developer. I use MongoDB for database and Express JS, Node Js for server side work. You can see i have done some MERN project.</p>
                        </div>
                       </div>
                    </div>
                    <div className="col__3">
                       <div className="service__box pointer">
                        ...
                        <div className="service__meta">
                         <h1 className="service__text">PSD To HTML</h1>
                         <p className="service__text p__color">I can covert any PSD design to a responsive webpage. I use HTML, CSS, Bootstrap, Vanilla Js, React JS for it. You can see some of my works in portfolio tab in this website</p>
                        </div>
                       </div>
                    </div>
                    <div className="col__3">
                       <div className="service__box pointer">
                        ...
                        <div className="service__meta">
                         <h1 className="service__text">Custom Web Applications Service</h1>
                         <p className="service__text p__color">loremLorem ipsum dolor sit ame</p>
                         <p className="service__text p__color">loremLorem ipsum dolor sit ame</p>
                         <p className="service__text p__color">loremLorem ipsum dolor sit ame</p>
                        </div>
                       </div>
                    ...
                    <div className="col__3">
                       <div className="service__box pointer">
                        ...
                        <div className="service__meta">
                         <h1 className="service__text">Content Management Systems</h1>
                         <p className="service__text p__color">loremLorem ipsum dolor sit ame</p>
                         <p className="service__text p__color">loremLorem ipsum dolor sit ame</p>
                         <p className="service__text p__color">loremLorem ipsum dolor sit ame</p>
                        </div>
                    ...
                    <div className="col__3">
                       <div className="service__box pointer">
                        ...
                        <div className="service__meta">
                         <h1 className="service__text">Web Support and Maintenance Service
</h1>
                         <p className="service__text p__color">loremLorem ipsum dolor sit ame</p>
                         <p className="service__text p__color">loremLorem ipsum dolor sit ame</p>
                         <p className="service__text p__color">loremLorem ipsum dolor sit ame</p>
